...
void ShaderManager::LoadShaders()
{
	...
	half.vsBlob = LoadShader(L"Resource/HLSL/OBJVertexShader.hlsl", "vs_5_0");
	half.psBlob = LoadShader(L"Resource/HLSL/HalfAlpha.hlsl", "ps_5_0");
